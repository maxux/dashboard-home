...
function __summary_node(node, host, server) {
...
/*
function rtinfo_parsing_local(response, host) {
    // console.log(response);
    var json = response;
...
function __switch_update_system(rootid, values) {
...
function __devices_update(clients) {
    var now = new Date();
